...
public class ProductEditDialogController {
	...
	private final ObservableList<Boolean> options = FXCollections.observableArrayList(true, false);
	private final ObservableList<String> units = productsInStoresController.listOfUnits();

	@FXML
	private void initialize() {

		avibility.setConverter(new StringConverter<>() {
