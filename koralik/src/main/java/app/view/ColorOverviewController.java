...
public class ColorOverviewController {
	...
	private final ObservableList<Color> masterData = (ObservableList<Color>) colorController.listColors();
	...
	private void initialize() {
		...
		colorFamilyColumn.setCellValueFactory(new PropertyValueFactory<>("colorFamilyName"));
		colorBox.getItems().setAll(colorFamilyController.listColorFamily());
		colorBox.getItems().add(0, new ColorFamily("Wszystkie", new HashSet<>()));
