...
public class StoresEditDialogController {
	...
	private ObservableList<Country> countryList = countryController.countriesList();
	...
	private void initialize() {
		...
		FilteredList<Country> filteredItems = new FilteredList<Country>(countryList, p -> true);
